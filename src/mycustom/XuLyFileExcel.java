...
public class XuLyFileExcel {
    ...
    public void xuatExcel(JTable tbl) {
        ...
        try {
            ...
            JFileChooser chooser = new MyFileChooser("D:\\Download");
    ...
    public void nhapExcel(JTable tbl) {
        ...
        try {
            ...
            FileNameExtensionFilter fnef = new FileNameExtensionFilter(".xlsx", "xlsx", "xlsx", "xlsx");
            chooser.setFileFilter(fnef);
